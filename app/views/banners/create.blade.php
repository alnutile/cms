...
<div class="col-md-9 column">
    ...
    <fieldset>
        <div class="form-group">
                ...
                <label for="email">Banner Name (<a href="http://www.restorationtrades.com/help.html#banner_name" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
          <label for="email">Banner Image Uploader (<a href="http://www.restorationtrades.com/help.html#banner_image_uploader" target="_blank">Help</a>)</label>
