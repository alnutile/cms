<div ng-app="app">
  <div ng-controller="PostImagesController">
    <ul ng-if="images.length > 0" class="edit_images sortable">
      <li ng-repeat="image in images | orderBy:'order'">
        <img class ="img-thumbnail" src="/assets/img/posts/[[image.file_name]]">&nbsp;[[image.file_name]]&nbsp;<i class="glyphicon glyphicon-trash" ng-click="deleteImage(image.id)">&nbsp;</i>
        <br>
    ...
    <div class="form-group">
      ...
      <div flow-init="{target: '/images/posts', singleFile: false}"
