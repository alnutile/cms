...
<div class="col-md-9 column">
    ...
    <div class="form-group">
        <label>Blog Post Name (<a href="https://www.corbettresearchgroupinc.com/admin_posts" target="_blank">Help</a>)</label>
    ...
    <!--   default images-->
    <div class="form-group">
        <label for="email">Default Image Uploader (<a href="https://www.corbettresearchgroupinc.com/admin_posts" target="_blank">Help</a>)</label>
