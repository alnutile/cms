...
<div class="col-md-9 column">
    ...
    <fieldset>
        <div class="form-group">
            <label for="email">Company Name (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
                <label for="logo">Company Logo Image Uploader (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        @endif
        <div class="form-group">
                <label for="email">Colors (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>&nbsp;
        ...
        <div class="form-group">
                <label for="email">Facebook (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
                <label for="email">Linkedin (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
                <label for="email">Twitter (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
                <label for="email">Pinterest (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
            <label for="email">Google Plus (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
            <label>Page Footer (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
        ...
        <div class="form-group">
            <div class="controls">
                <div class="checkbox">
                    <label class="checkbox">{{ Form::checkbox('maintenance_mode', null) }} Maintenance Mode (<a href="http://www.restorationtrades.com/help/admin_settings_light.html" target="_blank">Help</a>)</label>
                </div>
