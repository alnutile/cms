(function () {
    /**
     * This comes from
     * https://github.com/flowjs/flow.js/blob/master/samples/Node.js/public/index.html
     * @type {window.Flow}
     */
    var r = new Flow({
    ...
    r.on('fileAdded', function(file){
        ...
        $('.flow-list').append(
            '<li class="flow-file flow-file-'+file.uniqueIdentifier+'">' +
                ...
                ' <img src="/assets/img/cancel.png" title="Cancel upload" />' +
                '</span>' +
                '<input type="hidden" name="images[]" value="" class="images">'
        );
    ...
    r.on('fileSuccess', function(file,message){
        ...
        $self.find('.images').val(file.name);
